...
String item = "RuneLandConcrete";

class RuneLandConcrete extends StatefulWidget {
  @override
  _RuneLandConcreteState createState() => _RuneLandConcreteState();
}

class _RuneLandConcreteState extends State<RuneLandConcrete> {
  List<dynamic> data;
  ...
  void initState() {
    super.initState();
    this.getRuneLandConcreteItems(context);
  }

  void getRuneLandConcreteItems(BuildContext context) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Rune, Land & Concrete Items'),
  ...
  Widget searchBox() {
    return Scaffold(
      ...
      body: _allRuneLandConcreteList(),
    );
  }

  Widget _allRuneLandConcreteList() {
