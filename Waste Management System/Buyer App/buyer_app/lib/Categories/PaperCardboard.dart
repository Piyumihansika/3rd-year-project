...
String item = "PaperCardboard";

class PaperCardboard extends StatefulWidget {
  @override
  _PaperCardboardState createState() => _PaperCardboardState();
}

class _PaperCardboardState extends State<PaperCardboard> {
  List<dynamic> data;
  ...
  void initState() {
    super.initState();
    this.getPaperCardboardItems(context);
  }

  void getPaperCardboardItems(BuildContext context) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Paper & Cardboard Items'),
  ...
  Widget searchBox() {
    return Scaffold(
      ...
      body: _allPaperCardboardList(),
    );
  }

  Widget _allPaperCardboardList() {
