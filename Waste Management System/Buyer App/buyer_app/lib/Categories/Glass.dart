import 'dart:async';
//import 'dart:html';
//import 'package:buyerapp/bidding/Bid.dart';
...
class GlassDetail extends StatefulWidget {
  @override
  _GlassDetailState createState() => _GlassDetailState();
}

class _GlassDetailState extends State<GlassDetail> {
  @override
...
class Glass extends StatefulWidget {
  @override
  _GlassState createState() => new _GlassState();
}
              ...
              child: _searchResult.length != 0 || controller.text.isNotEmpty
                  ...
                  : new ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (_itemDetails[index].category == 'Glass') {
                          return Container(
                            width: 700,
                            child: new Card(
