...
String item = "OtherMetals";

class OtherMetals extends StatefulWidget {
  @override
  _OtherMetalsState createState() => _OtherMetalsState();
}

class _OtherMetalsState extends State<OtherMetals> {
  List<dynamic> data;
  ...
  void initState() {
    super.initState();
    this.getOtherMetalsItems(context);
  }

  void getOtherMetalsItems(BuildContext context) async {
  ...
  Widget searchBox() {
    return Scaffold(
      ...
      body: _allOtherMetalsList(),
    );
  }

  Widget _allOtherMetalsList() {
