...
class _SpecialsState extends State<Specials> {
  ...
  void initState() {
    super.initState();
    this.getSpecialsItems(context);
  }

  void getSpecialsItems(BuildContext context) async {
  ...
  Widget searchBox() {
    return Scaffold(
      ...
      body: _allSpecialsList(),
    );
  }

  Widget _allSpecialsList() {
