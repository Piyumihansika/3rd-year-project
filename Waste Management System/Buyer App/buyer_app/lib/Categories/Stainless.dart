...
String item = "Stainless";

class Stainless extends StatefulWidget {
  @override
  _StainlessState createState() => _StainlessState();
}

class _StainlessState extends State<Stainless> {
  List<dynamic> data;
  ...
  void initState() {
    super.initState();
    this.getStainlessItems(context);
  }

  void getStainlessItems(BuildContext context) async {
  ...
  Widget searchBox() {
    return Scaffold(
      ...
      body: _allStainlessList(),
    );
  }

  Widget _allStainlessList() {
