...
class BrashDetail extends StatefulWidget {
  @override
  _BrashDetailState createState() => _BrashDetailState();
}

class _BrashDetailState extends State<BrashDetail> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Brash Items'),
...
class Brash extends StatefulWidget {
  @override
  _BrashState createState() => new _BrashState();
}
...
class _BrashState extends State<Brash> {
              ...
              child: _searchResult.length != 0 || controller.text.isNotEmpty
                  ...
                  : new ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (_itemDetails[index].category == 'Brash') {
                          return Container(
                            width: 700,
                            child: new Card(
